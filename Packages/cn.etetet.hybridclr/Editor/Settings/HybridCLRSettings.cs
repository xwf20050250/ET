...
namespace HybridCLR.Editor.Settings
{
    ...
    public class HybridCLRSettings : ScriptableSingleton<HybridCLRSettings>
    {
        ...
        public string hybridclrRepoURL = "git@github.com:focus-creative-games/hybridclr.git";

        [Header("il2cpp_plus 仓库 URL")]
        public string il2cppPlusRepoURL = "git@github.com:focus-creative-games/il2cpp_plus";
